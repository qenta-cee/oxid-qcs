...
$aModule = [
    ...
    'extend' => [
        \OxidEsales\Eshop\Application\Controller\OrderController::class => \Qenta\Extend\Controller\OrderController::class,
    ...
    'templates' => [
        'qmorecheckoutseamlessiframecheckout.tpl' => 'views/page/checkout/iframecheckout.tpl',
        'qmorecheckoutseamlesssubmitconfig.tpl' => 'views/admin/tpl/qmorecheckoutseamlesssubmitconfig.tpl',
        'qcs_payment_ccard.tpl' => 'views/blocks/paymethods/qcs_payment_ccard.tpl',
        'qcs_payment_eps.tpl' => 'views/blocks/paymethods/qcs_payment_eps.tpl',
        'qcs_payment_giropay.tpl' => 'views/blocks/paymethods/qcs_payment_giropay.tpl',
        'qcs_payment_idl.tpl' => 'views/blocks/paymethods/qcs_payment_idl.tpl',
        'qcs_payment_installment.tpl' => 'views/blocks/paymethods/qcs_payment_installment.tpl',
        'qcs_payment_invoice.tpl' => 'views/blocks/paymethods/qcs_payment_invoice.tpl',
        'qcs_payment_pbx.tpl' => 'views/blocks/paymethods/qcs_payment_pbx.tpl',
        'qcs_payment_sepa_dd.tpl' => 'views/blocks/paymethods/qcs_payment_sepa_dd.tpl',
        'qcs_payment_trustpay.tpl' => 'views/blocks/paymethods/qcs_payment_trustpay.tpl',
        'qcs_payment_voucher.tpl' => 'views/blocks/paymethods/qcs_payment_voucher.tpl',
        'qcs_payment_other.tpl' => 'views/blocks/paymethods/qcs_payment_other.tpl',
    ],
    'blocks' => [
    ...
    'settings' => [
        ...
        ['group' => 'qcs_invoice_settings', 'name' => 'bInvoiceb2bTrustedShopsCheckbox', 'type' => 'bool', 'value' => 'true'],
        ['group' => 'qcs_invoice_settings', 'name' => 'bInvoiceb2cTrustedShopsCheckbox', 'type' => 'bool', 'value' => 'true'],
        ['group' => 'qcs_invoice_settings', 'name' => 'bInvoiceAllowDifferingAddresses', 'type' => 'bool', 'value' => 'true'],
        ...
        ['group' => 'qcs_installment_settings', 'name' => 'bInstallmentTrustedShopsCheckbox', 'type' => 'bool', 'value' => 'true'],
        ['group' => 'qcs_installment_settings', 'name' => 'bInstallmentAllowDifferingAddresses', 'type' => 'bool', 'value' => 'true'],
