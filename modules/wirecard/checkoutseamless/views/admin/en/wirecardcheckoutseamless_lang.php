...
$aLang = array(
    ...
    'SHOP_MODULE_GROUP_wcs_installment_invoice_settings' => 'Installment/Invoice Settings',
    ...
    'SHOP_MODULE_bSendAdditionalCustomerData' => 'Forward consumer data',
    'HELP_SHOP_MODULE_bSendAdditionalCustomerData' => 'Forwarding shipping and billing data about your consumer to the respective financial service provider.',
    ...
    'HELP_SHOP_MODULE_sPayolutionMId' => 'Your payolution merchant ID consisting of the base64-encoded company name which is used in the link for "consent" to the payolution terms.Your payolution merchant ID consisting of the base64-encoded company name which is used in the link for "consent" to the payolution terms (https://www.base64encode.org/).',
    'SHOP_MODULE_bPayolutionAllowDifferingAddresses' => 'For payolution: Allowing shipping address to differ from billing address.',
    'SHOP_MODULE_bInvoiceb2bTrustedShopsCheckbox' => 'Display "Trusted Shops"-checkbox for payolution invoice B2B',
    'SHOP_MODULE_bInvoiceb2cTrustedShopsCheckbox' => 'Display "Trusted Shops"-checkbox for payolution invoice B2C',
    'SHOP_MODULE_bInstallmentTrustedShopsCheckbox' => 'Display "Trusted Shops"-checkbox for payolution installment',
    'SHOP_MODULE_sInvoiceInstallmentProvider' => 'Installment/Invoice Provider',
    ...
    'WIRECARD_CHECKOUT_SEAMLESS_SOFORTUEBERWEISUNG_LABEL' => 'SOFORT Banking',
    ...
    'ORDER_OVERVIEW_WIRECARD_CHECKOUT_SEAMLESS_SENDERACCOUNTNUMBER' => 'SOFORT sender account number',
    'ORDER_OVERVIEW_WIRECARD_CHECKOUT_SEAMLESS_SENDERBANKNUMBER' => 'SOFORT sender bank sorting code',
    'ORDER_OVERVIEW_WIRECARD_CHECKOUT_SEAMLESS_SENDERBANKNAME' => 'SOFORT sender bank name',
    ...
    'ORDER_OVERVIEW_WIRECARD_CHECKOUT_SEAMLESS_SENDERCOUNTRY' => 'SOFORT sender country',
    'ORDER_OVERVIEW_WIRECARD_CHECKOUT_SEAMLESS_SENDERCRITERIA' => 'SOFORT sender criteria',
