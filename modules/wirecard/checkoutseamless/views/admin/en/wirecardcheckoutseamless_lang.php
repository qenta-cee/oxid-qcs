...
$aLang = array(
    ...
    'HELP_SHOP_MODULE_sInstallmentPayolutionMId' => 'Your payolution merchant ID consisting of the base64-encoded company name which is used in the link for "consent" to the payolution terms.Your payolution merchant ID consisting of the base64-encoded company name which is used in the link for "consent" to the payolution terms (https://www.base64encode.org/).',
    'SHOP_MODULE_bInstallmentAllowDifferingAddresses' => 'For payolution: Allowing shipping address to differ from billing address.',
