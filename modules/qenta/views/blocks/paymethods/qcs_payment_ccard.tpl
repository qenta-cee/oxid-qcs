...
<dl>
    ...
    <dd class="[{if $oView->getCheckedPaymentId() == $paymentmethod->oxpayments__oxid->value}]activePayment[{/if}]">
        ...
        <div class="desc">
            [{ oxmultilang ident="QMORECHECKOUTSEAMLESS_PAYMENTDATA_ALREADY_STORED" }]
        </div>
        [{/if}]
        ...
        <ul class="form">
            <li>
                <label>[{ oxmultilang ident="QMORECHECKOUTSEAMLESS_CARDNUMBER" }]</label>
            ...
            <li>
                <label>[{ oxmultilang ident="QMORECHECKOUTSEAMLESS_CARDHOLDER" }]</label>
            ...
            [{/if}]
            <li>
                <label>[{ oxmultilang ident="QMORECHECKOUTSEAMLESS_VALID_UNTIL" }]</label>
            ...
            <li>
                <label>[{ oxmultilang ident="QMORECHECKOUTSEAMLESS_CVC" }]</label>
                ...
                <div class="note">
                    [{ oxmultilang ident="QMORECHECKOUTSEAMLESS_CVC_DESCRIPTION" }]
                    <a href="#" onclick="javascript:window.open('[{$oViewConf->getModuleUrl('qmorecheckoutseamless','out/img/cvc_help.jpg')}]','ccard_cvc','toolbar=no, location=no, directories=no, status=no, menubar=no, scrollbars=yes, resizable=yes, width=190, height=790');return false;">
                        [{ oxmultilang ident="QMORECHECKOUTSEAMLESS_CVC_EXAMPLE" }]
                    </a>
                </div>
            </li>
            [{/if}]
            ...
            <li>
                <label>[{ oxmultilang ident="QMORECHECKOUTSEAMLESS_ISSUE_DATE" }]</label>
            ...
            <li>
                <label>[{ oxmultilang ident="QMORECHECKOUTSEAMLESS_ISSUE_NUMBER" }]</label>
