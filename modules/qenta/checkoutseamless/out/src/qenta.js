    ...
    var ddQentaPayment = {
        ...
        _create: function () {
            ...
            if ($('#qentaCheckoutSeamless_ccardIframeContainer').length > 0) {
                this.paymentTypes['qcs_ccard'].iframe = qenta.buildIframeCreditCard('qentaCheckoutSeamless_ccardIframeContainer', '100%', '160px');
            }
            if ($('#qentaCheckoutSeamless_ccard-motoIframeContainer').length > 0) {
                this.paymentTypes['qcs_ccard-moto'].iframe = qenta.buildIframeCreditCard('qentaCheckoutSeamless_ccard-motoIframeContainer', '100%', '160px');
            }
