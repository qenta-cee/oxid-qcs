...
class qentaCheckoutSeamlessConfig
{
    ...
    protected function _getModule()
    {
        if ($this->_oModule === null) {
            ...
            $this->_oModule->load('qentacheckoutseamless');
        }
    ...
    {
        if (is_object(oxRegistry::get('qentaCheckoutSeamlessConfig'))) {
            return oxRegistry::get('qentaCheckoutSeamlessConfig');
        }

        oxRegistry::set('qentaCheckoutSeamlessConfig', new self());
    }
}
