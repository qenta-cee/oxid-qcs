...
<dl>
        ...
        <ul class="form">
            ...
            <li>
                ...
                <select name="[{ $prefix }]_expirationMonth">
                    ...
                    <option [{ if $qentaCheckoutSeamless_paymentdata.ccard_month == "03"}]selected[{/if}]>03</option>
                    <option [{ if $qentaCheckoutSeamless_paymentdata.ccard_month == "04"}]selected[{/if}]>04</option>
                    <option [{ if $qentaCheckoutSeamless_paymentdata.ccard_month == "05"}]selected[{/if}]>05</option>
                    <option [{ if $qentaCheckoutSeamless_paymentdata.ccard_month == "06"}]selected[{/if}]>06</option>
                    <option [{ if $qentaCheckoutSeamless_paymentdata.ccard_month == "07"}]selected[{/if}]>07</option>
                    <option [{ if $qentaCheckoutSeamless_paymentdata.ccard_month == "08"}]selected[{/if}]>08</option>
                    <option [{ if $qentaCheckoutSeamless_paymentdata.ccard_month == "09"}]selected[{/if}]>09</option>
                    <option [{ if $qentaCheckoutSeamless_paymentdata.ccard_month == "10"}]selected[{/if}]>10</option>
                    <option [{ if $qentaCheckoutSeamless_paymentdata.ccard_month == "11"}]selected[{/if}]>11</option>
                    <option [{ if $qentaCheckoutSeamless_paymentdata.ccard_month == "12"}]selected[{/if}]>12</option>
                </select>
                ...
                <select name="[{ $prefix }]_expirationYear">
                    ...
                    <option [{ if $qentaCheckoutSeamless_paymentdata.ccard_year == $year}]selected[{/if}]>[{$year}]</option>
                    [{/foreach}]
                </select>
            </li>
            ...
            <li>
                ...
                <select name="[{ $prefix }]_issueMonth">
                    ...
                    <option [{ if $qentaCheckoutSeamless_paymentdata.ccard_issuemonth == "03"}]selected[{/if}]>03</option>
                    <option [{ if $qentaCheckoutSeamless_paymentdata.ccard_issuemonth == "04"}]selected[{/if}]>04</option>
                    <option [{ if $qentaCheckoutSeamless_paymentdata.ccard_issuemonth == "05"}]selected[{/if}]>05</option>
                    <option [{ if $qentaCheckoutSeamless_paymentdata.ccard_issuemonth == "06"}]selected[{/if}]>06</option>
                    <option [{ if $qentaCheckoutSeamless_paymentdata.ccard_issuemonth == "07"}]selected[{/if}]>07</option>
                    <option [{ if $qentaCheckoutSeamless_paymentdata.ccard_issuemonth == "08"}]selected[{/if}]>08</option>
                    <option [{ if $qentaCheckoutSeamless_paymentdata.ccard_issuemonth == "09"}]selected[{/if}]>09</option>
                    <option [{ if $qentaCheckoutSeamless_paymentdata.ccard_issuemonth == "10"}]selected[{/if}]>10</option>
                    <option [{ if $qentaCheckoutSeamless_paymentdata.ccard_issuemonth == "11"}]selected[{/if}]>11</option>
                    <option [{ if $qentaCheckoutSeamless_paymentdata.ccard_issuemonth == "12"}]selected[{/if}]>12</option>
                </select>
                ...
                <select name="[{ $prefix }]_issueYear">
                    [{foreach from=$oViewConf->getCreditCardIssueYears() item=year}]
                        <option [{ if $qentaCheckoutSeamless_paymentdata.ccard_issueyear == $year}]selected[{/if}]>[{$year}]</option>
                    [{/foreach}]
                </select>
            </li>
            [{/if}]
    ...
    [{else}]
        <div id="qentaCheckoutSeamless_[{ $prefix }]IframeContainer"></div>
    [{/if}]
</dl>
[{/if}]