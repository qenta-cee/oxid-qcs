...
class qentacheckoutseamlessSubmitConfig extends oxAdminView
{
     ...
     * file "qentacheckoutseamlesssubmitconfig.tpl".
     *
     * @return string
     */
    ...
    public function submit()
    {
        ...
        $Mail->setSubject('OXID QCS Plugin Configuration from ' . oxRegistry::getConfig()->getActiveShop()->oxshops__oxname->rawValue);
        if ($replyTo) {
